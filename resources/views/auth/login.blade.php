            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li><a href="{{ route('users.index') }}" class="nav-link">Kelola Users</a></li>
                        @endcanany
                        @canany(['create-tracerstudy','edit-tracerstudy', 'delete-tracerstudy'])
                        <li><a href="" class="nav-link">Tracer Study</a></li>
                        @endcanany
