                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <div aria-label="Aksi Data">
                                        ...
                                        <form action="{{ route('info-beasiswa.destroy', $item->id) }}" method="POST" class="d-inline-block m-0 p-0 delete-form">
                                            @csrf
                                            @method('DELETE')
    ...
    document.querySelectorAll('.btn-delete').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            Swal.fire({
                ...
                text: "Data beasiswa ini beserta akun loginnya akan dihapus permanen!",
                icon: 'warning',
